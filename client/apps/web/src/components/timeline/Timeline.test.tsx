...
describe('Timeline', () => {
  ...
  it('shows the parallel-session capacity wait message', () => {
    render(
      <Timeline
        items={[
          {
            kind: 'run_status',
            id: 'status_capacity_wait',
            runId: 'run_capacity_wait',
            label: 'queued',
            source: 'runtime'
          },
          {
            kind: 'diagnostic',
            id: 'diagnostic_capacity_wait',
            runId: 'run_capacity_wait',
            severity: 'warning',
    ...
    expect(screen.getByText('并行会话已达 10 个上限，当前任务正在等待可用执行位置'))
      .toBeInTheDocument();
  });
