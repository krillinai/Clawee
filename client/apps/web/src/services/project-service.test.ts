...
describe('ProjectService', () => {
  it('uses Runtime project, migration, and assignment endpoints', async () => {
    ...
    await service.selectProjectDirectory('create');
    ...
    await service.reorderProjects({ projectIds: ['project-one', 'project-two'] });
    ...
    expect(post).toHaveBeenCalledWith('/projects/directory-selection', {
      purpose: 'create'
    });
    ...
    expect(post).toHaveBeenCalledWith('/projects/reorder', {
