...
import { isImageAttachmentMime } from '../../services/attachment-types.js';
...
export function AttachmentTray(props: {
  ...
  const previewItem = props.items.find(item => (
    item.localId === previewLocalId && isImageAttachmentMime(item.mime)
  ));
