...
const api: DesktopApi = {
  ...
  selectProjectDirectory: purpose =>
    ipcRenderer.invoke(desktopIpc.selectProjectDirectory, purpose),
...
function resolveDesktopPlatform(platform: NodeJS.Platform): DesktopPlatform {
