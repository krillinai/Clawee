...
export const permissions = {
  ...
  knowledgeMemberCreate: "console:knowledge:member_create",
  knowledgeMemberUpdate: "console:knowledge:member_update",
  knowledgeMemberDelete: "console:knowledge:member_delete",
  ...
  skillSpaceMemberDelete: "console:skill:space_member_delete",
  ...
  sharedFilesMemberCreate: "console:shared_files:member_create",
  sharedFilesMemberUpdate: "console:shared_files:member_update",
  sharedFilesMemberDelete: "console:shared_files:member_delete",
  sharedFilesDownload: "console:shared_files:download",
  sharedFilesUpload: "console:shared_files:upload",
  sharedFilesStorageRead: "console:shared_files:storage_read",
  sharedFilesStorageManage: "console:shared_files:storage_manage",
  sharedFilesStorageMigrate: "console:shared_files:storage_migrate",
