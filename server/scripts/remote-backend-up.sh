...
APP_NAME="${CLAW_GATEWAY_APP_NAME:-claw-gateway}"
APP_BIN="${CLAW_GATEWAY_APP_BIN:-$ROOT_DIR/bin/claw-gateway}"
APP_ADDR="${CLAW_GATEWAY_SERVER_ADDR:-:1904}"
APP_HOST="${CLAW_GATEWAY_HEALTH_HOST:-127.0.0.1}"
APP_PORT="${CLAW_GATEWAY_PORT:-${APP_ADDR##*:}}"
APP_PID_FILE="${CLAW_GATEWAY_PID_FILE:-$ROOT_DIR/tmp/claw-gateway.pid}"
APP_LOG_FILE="${CLAW_GATEWAY_LOG_FILE:-$ROOT_DIR/tmp/claw-gateway.log}"

POSTGRES_IMAGE="${POSTGRES_IMAGE:-postgres:16}"
POSTGRES_CONTAINER="${POSTGRES_CONTAINER:-clawee-postgres}"
POSTGRES_VOLUME="${POSTGRES_VOLUME:-clawee-postgres-data}"
POSTGRES_DB="${POSTGRES_DB:-claw_gateway}"
POSTGRES_USER="${POSTGRES_USER:-claw_gateway}"
POSTGRES_PORT="${POSTGRES_PORT:-15932}"

export CLAW_GATEWAY_SERVER_ADDR="$APP_ADDR"
