...
func mountSkillHubAdminRoutes(admin *gin.RouterGroup, opts Options) {
	...
	admin.POST("/skills/versions", skillOperationLog(opts.Logger, skillActionUpload), manage, handleSkillUpload(opts.SkillHubService, false))
	admin.PATCH("/skills/space", skillBatchMoveOperationLog(opts.Logger), manage, handleSkillMoveSpace(opts.SkillHubService))
	admin.PUT("/skills/current-version", skillOperationLog(opts.Logger, skillActionSet), manage, handleSkillSetCurrent(opts.SkillHubService))
	admin.POST("/skills/current-version/remove", skillOperationLog(opts.Logger, skillActionClear), manage, handleSkillClearCurrent(opts.SkillHubService))
	if opts.SkillSourceService == nil {
		return
	}
	admin.GET("/skill-sources", read, handleSkillSourceList(opts.SkillSourceService))
	admin.POST("/skill-sources", skillSourceOperationLog(opts.Logger, skillSourceActionCreate), manage, handleSkillSourceCreate(opts.SkillSourceService))
	admin.GET("/skill-sources/detail", read, handleSkillSourceDetail(opts.SkillSourceService))
	admin.GET("/skill-sources/token", manage, handleSkillSourceToken(opts.SkillSourceService))
	admin.PUT("/skill-sources", skillSourceOperationLog(opts.Logger, skillSourceActionUpdate), manage, handleSkillSourceUpdate(opts.SkillSourceService))
	admin.POST("/skill-sources/sync", skillSourceOperationLog(opts.Logger, skillSourceActionSync), manage, handleSkillSourceSync(opts.SkillSourceService))
	admin.POST("/skill-sources/scan-local", skillSourceOperationLog(opts.Logger, skillSourceActionLocalScan), manage, handleSkillSourceLocalScan(opts.SkillSourceService))
	admin.POST("/skill-sources/disable", skillSourceOperationLog(opts.Logger, skillSourceActionDisable), manage, handleSkillSourceStatus(opts.SkillSourceService, false))
	admin.POST("/skill-sources/enable", skillSourceOperationLog(opts.Logger, skillSourceActionEnable), manage, handleSkillSourceStatus(opts.SkillSourceService, true))
	admin.POST("/skill-sources/token/remove", skillSourceOperationLog(opts.Logger, skillSourceActionRemoveToken), manage, handleSkillSourceRemoveToken(opts.SkillSourceService))
	admin.POST("/skill-sources/items/bind", skillSourceOperationLog(opts.Logger, skillSourceActionBind), manage, handleSkillSourceBind(opts.SkillSourceService))
	admin.POST("/skill-sources/items/unbind", skillSourceOperationLog(opts.Logger, skillSourceActionUnbind), manage, handleSkillSourceUnbind(opts.SkillSourceService))
